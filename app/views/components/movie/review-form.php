    ...
    <div class="form-container">
        <form id="review-form" action="/proyectodaw/review/save/" method="post" autocomplete="off">
            <div class="form-group">
                <label for="user-id" id="user-id" class="d-none">User id
                    <input class="form-control" type="number" name="user-id" value="<?php echo $user_id ?>">
                </label>
                ...
                <label for="review-id" class="d-none">Review id
                    <input class="form-control" type="number" name="review-id" value="0" <?php echo $readonly ?>>
                </label>
            ...
            <div class="form-group">
                <label for="review">Reseña
                    <textarea class="form-control" name="review" id="review" rows="4"
                              placeholder="Escribe tu reseña aquí"
                              required <?php echo $readonly ?>></textarea>
                </label>
            </div>
